...
<?php if ( have_comments() ) : ?>
	...
	<div id="comment_feed">
		...
		<a href="<?php echo get_post_comments_feed_link($post_id, $feed);?>" class="has_icon rss_icon">Comment Feed</a>
	</div>
								 
	<ol class="commentlist">
		<?php wp_list_comments("reply_text=Reply to this Comment&callback=custom_comment");?>
	</ol>
