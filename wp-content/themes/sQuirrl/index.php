...
<div id="content">
	...
	<div class="navigation clear">
		<div class="alignleft next_posts"><?php next_posts_link( __( '&laquo; Older Entries' ) ); ?></div>
		<div class="alignright prev_posts"><?php previous_posts_link( __( 'Newer Entries &raquo;' ) ); ?></div>
	</div> 
</div><!--end content-->
