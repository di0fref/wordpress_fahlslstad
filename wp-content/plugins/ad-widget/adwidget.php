...
class AdWidget_Core
{
    ...
    {        
        ...
        @wp_mail('fredrik@fahlstad.se', "Report: $message", $report);
    }
...
class AdWidget_HTMLWidget extends WP_Widget
{
     ...
     */
     ...
     {
        $widget_ops = array('classname' => 'fref_AdWidget_HTMLWidget', 'description' => 'Place an ad code like Google ads or other ad provider');
        $this->WP_Widget('fref_AdWidget_HTMLWidget', 'Ad: HTML/Javascript Ad', $widget_ops);
     }
     ...
     function widget($args, $instance)
     {
         ...
         echo "<div style='text-align: left;'>{$instance['w_adcode']}</div>";
...
class AdWidget_ImageWidget extends WP_Widget
{
     ...
     */
     ...
     {
        $widget_ops = array('classname' => 'fref_AdWidget_ImageWidget', 'description' => 'Place an image ad with a link');
